...
# 生成したデータの保存先 画像&csv
image_save_path = "/root/dataset/SD_generated_dataset/radiantLightV2/images"
annotation_save_path = "/root/dataset/SD_generated_dataset/radiantLightV2/annotations"
...
api = webuiapi.WebUIApi(host='192.168.30.10', port=7861)
# anotation_data_lists


# パラメータ類----------------------------------------------------------------------------------------
load_image_num = range(501,7500) # csvの列ナンバー
