...
parser.add_argument("--DIRNAME",type=str, help="str: save dir name")
...
# 生成したデータの保存先 画像&csv
image_save_path = f"/root/dataset/SD_generated_dataset/{DIRNAME}/images"
annotation_save_path = f"/root/dataset/SD_generated_dataset/{DIRNAME}/annotations"

create_directory_if_not_exists(f"/root/dataset/SD_generated_dataset")
create_directory_if_not_exists(f"/root/dataset/SD_generated_dataset/{DIRNAME}")
create_directory_if_not_exists(f"/root/dataset/SD_generated_dataset/{DIRNAME}/annotations")
create_directory_if_not_exists(f"/root/dataset/SD_generated_dataset/{DIRNAME}/images")
...
def main():
    ...
    # パラメータ類----------------------------------------------------------------------------------------
    load_image_num = range(500) # csvの列ナンバー
