...
# 生成したデータの保存先 画像&csv
image_save_path = "/root/dataset/SD_generated_dataset/radiantLightV2_3/images"
annotation_save_path = "/root/dataset/SD_generated_dataset/radiantLightV2_3/annotations"
...
# パラメータ類----------------------------------------------------------------------------------------
load_image_num = range(7500) # csvの列ナンバー
...
for image_num in load_image_num:
    ...
    for prompt_num,prompt in enumerate(prompts):
        ...
        # latest_tagname = get_latest_tagname()e
